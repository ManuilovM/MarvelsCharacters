...
export const initialState: State = {
    charactersList: Icharacterslist
};

const charsctersReducer = createReducer(
  initialState, 
  on(CharactersActions.addCharacter, (state, {characters})=>(
    {charactersList:initialState.charactersList.concat(characters)}
    )
    )
)
export function reduser(state: State | undefined, action: Action){
